            ...
            <div class="col-12 ">
                <div style="padding-top: 50%; border-radius: 25px" class=" mt-5 center  justify-content-center mdc-card p-4 align-middle shadow">
                    <div class="card-body ">
                        ...
                        <hr>
                        <form:form class="align-middle" modelAttribute="mechanic" onsubmit="return validateForm()">
                                ...
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-8 col-md-6">
                                            <form:input path="mechanicId" class="form-control" id="mechanicId" autocomplete="off" name="mechanicId" aria-describedby="mechanicIdHelp"
                            ...
                            <div class="form-group">
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-8 col-md-6">
                                            <form:input path="mechanicName" class="form-control" id="mechanicName" autocomplete="off" name="mechanicName" aria-describedby="mechanicUsernamehelp"
                            ...
                            <div class="form-group">
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-8 col-md-6">
                                            <form:input path="mechanicEmailId" class="form-control" id="mechanicEmailId" autocomplete="off" name="mechanicEmailId" placeholder="abc@mail_id.com "
                                        ...
                                        <div class="col">
                                            <div class="mdc-form-field">
                                                <div class="mdc-radio mt-1">
                                                    <form:radiobutton class="mdc-radio__native-control" path="mechanicGender" id="male" value="0" name="mechanicGender"/>
                                                ...
                                                <div class="mdc-radio mt-1">
                                                    <form:radiobutton class="mdc-radio__native-control" path="mechanicGender" id="female" value="1" name="mechanicGender"/>
                                                    <div class="mdc-radio__background">
                                                        <div class="mdc-radio__outer-circle"></div>
                                                        <div class="mdc-radio__inner-circle"></div>
                                                    </div>
                            ...
                            <div class="form-group">
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-8 col-md-6">
                                            <form:input type="date" path="mechanicDOB" class="form-control" id="DOB" name="DOB" min="1950-12-31" max="2000-12-31" placeholder="yyyy-mm-dd"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-8 col-md-6">
                                            <form:input path="mechanicContactNo" class="form-control" id="mechanicContactNo" autocomplete="off" name="mechanicContactNo" aria-describedby="phoneNumberHelp"
                            ...
                            <div class="form-group">
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-8 col-md-6">
                                            <form:input path="mechanicLatitude" class="form-control" id="mechanicLocateLatitude" readonly="" name="mechanicLocateLatitude" aria-describedby="locationHelp"
                            ...
                            <div class="form-group">
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-8 col-md-6">
                                            <form:input path="mechanicLongitude" class="form-control" id="mechanicLocateLongitude" readonly="" name="mechanicLocateLongitude" aria-describedby="LocationHelp"
                                                placeholder="" data-toggle="popover" title="Location Help" data-content=""/>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-8 col-md-6">
                                            <form:password path="mechanicPassword" class="form-control" id="password" name="password" placeholder="Password" data-toggle="popover" title="password must be alphabetic"
                                                data-content=""/>
                            ...
                            <div class="form-group">
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-8 col-md-6">
                                            <form:password path="" class="form-control mt-3" id="confirmPassword" name="confirmPassword" placeholder="re-enter password"
