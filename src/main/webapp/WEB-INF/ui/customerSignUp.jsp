...
<body>
	...
	<div class="navigation">
		<div class=" check  p-1">
			...
			</a> <a class=" text-sm-right nav-link">Login</a> <a
				class=" text-sm-right nav-link active"  data-toggle="modal" data-target="#myModal">SignUp</a> <a
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Signup as </h4>
        </div>
        <div class="modal-body">
          <button id="asCustomer" class="btn btn-info btn-lg">Customer</button>
      	  <button id="asMechanic" class="btn btn-info btn-lg">Mechanic</button>
        </div>
			...
			<div class="col-12 ">
				<div style="padding-top: 50%; border-radius: 25px"
					...
					<div class="card-body ">
						...
						<hr>
						<form:form class="align-middle" method="get" modelAttribute="customers"
